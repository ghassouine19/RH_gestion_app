...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> register(@ModelAttribute RegisterRequest request) throws IOException {
        ...
        newUser.setCnss(request.getCnss());
        newUser.setRib(request.getRib());
        newUser.setDateNaissance(request.getDateNaissance());
        newUser.setDateEntree(request.getDateEntree());
        newUser.setDateSortie(request.getDateSortie());

        if (request.getPhoto() != null) {
            newUser.setPhoto(request.getPhoto().getBytes());
        }

        if (request.getDocument() != null) {
            newUser.setDocument(request.getDocument().getBytes());
        }
